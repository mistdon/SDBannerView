...
//         NSLog(@"button.tag = %lu",(long)button.tag);
...
#pragma mark - SDTabBarController -
@interface SDTabBarController ()<SDTabBarViewDelegate>
...
- (instancetype)init{
    if (self = [super init]) {
        ...
        _tabBarView                   = [[SDTabBarView alloc] initWithFrame:CGRectMake(0, SD_SCREENHEIGHT - 49, SD_SCREENWIDTH, 49)];
        _tabBarView.backgroundColor   = [UIColor whiteColor];
        _tabBarView.delegate          = self;
        _tabBarView.selectedItemIndex = 0;
        _tabBarView.showCenteralItem  = YES;
...
//    [delegate.menu presentLeftMenuViewController];
}
//- (void)hhhhhh{
//    AppDelegate *delegate = [UIApplication sharedApplication].delegate;
...
//        self.mm_drawerController.centerViewController.view.center = CGPointMakeWithDictionaryRepresentation(<#CFDictionaryRef  _Nullable dict#>, <#CGPoint * _Nullable point#>);
//    }];
//    
//}
...
#pragma mark - sdtabbarviewdelegate
